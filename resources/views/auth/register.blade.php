                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <label for="fname" class="col-md-4 col-form-label text-md-end">{{ __('first name')
                                    }}</label>
                            ...
                            <div class="col-md-6">
                                <label for="lname" class="col-md-4 col-form-label text-md-end">{{ __('last name')
                                    }}</label>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <label for="address1" class="col-md-4 col-form-label text-md-end">{{ __('address')
                                    }}</label>
                            ...
                            <div class="col-md-6">
                                <label for="address2" class="col-md-4 col-form-label text-md-end">{{ __('address 2')
                                    }}</label>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="pincode" class="col-md-4 col-form-label text-md-end">{{ __('pincode')
                                    }}</label>
                                <input id="pincode" type="text"
                                    class="form-control @error('pincode') is-invalid @enderror" name="pincode"
                                    value="{{ old('pincode') }}" autofocus>
