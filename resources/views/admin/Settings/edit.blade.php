                ...
                <form action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="phone" name="phone"
                            value="{{ $settings->settings['phone'] }}" required>
                    </div>
                    {{-- <div class="form-group">
                        <label for="mobile">Phone 2</label>
                        <input type="text" class="form-control" id="mobile" name="mobile"
                            value="{{ $settings->settings['mobile'] }}" required>
                    ...
                    {{-- <div class="form-group">
                        ...
                        <textarea class="form-control" id="about" name="about" required>{{ $settings->settings['about'] }}</textarea>
                    </div> --}}

                    <div class="form-group">
                        <label for="address">Address</label>
                        <input type="text" class="form-control" id="address" name="address"
                            value="{{ $settings->settings['address'] }}" required>
                    </div>

                    <div class="form-group">
                        <label for="email">Email</label>
                        <input type="email" class="form-control" id="email" name="email"
                            value="{{ $settings->settings['email'] }}" required>
                    </div>

                    <div class="form-group">
                        <label for="whatsapp">Whatsapp</label>
                        <input type="text" class="form-control" id="whatsapp" name="whatsapp"
                            value="{{ $settings->settings['whatsapp'] }}" required>
                    </div>
                    <div class="form-group">
                        <label for="facebook">Facebook</label>
                        <input type="text" class="form-control" id="facebook" name="facebook"
                            value="{{ $settings->settings['facebook'] }}" required>
                    </div>
                    {{-- <div class="form-group">
                        <label for="twitter">Twitter</label>
                        <input type="text" class="form-control" id="twitter" name="twitter"
                            value="{{ $settings->settings['twitter'] }}" required>
                    </div> --}}
                    {{-- <div class="form-group">
                        <label for="linkedin">Linkdin</label>
                        <input type="text" class="form-control" id="linkedin" name="linkedin"
                            value="{{ $settings->settings['linkedin'] }}" required>
                    </div> --}}
                    ...
                    <div class="form-group">
                        ...
                        @if ($settings->settings['header_logo'])
                            <img src="{{ $settings->settings['header_logo'] }}" style="width: 100px;">
                        @endif
                    </div>
                    <div style="display: none;" id="image-preview-section1">
                        @if ($settings->settings['header_logo'])
                            <img src="{{ $settings->settings['header_logo'] }}" id="image-preview1" alt="your image"
                                style="display:{{ is_null($settings->settings['header_logo']) ? 'none' : 'block' }}; width: 100px; ">
                        @endif
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        @if ($settings->settings['footer_logo'])
                            <img src="{{ $settings->settings['footer_logo'] }}"style="width: 100px;">
                        @endif
                    </div>
                    <div style="display: none;" id="image-preview-section2">
                        @if ($settings->settings['footer_logo'])
                            <img src="{{ $settings->settings['footer_logo'] }}" id="image-preview2" alt="your image"
                                style="display:{{ is_null($settings->settings['footer_logo']) ? 'none' : 'block' }}; width: 100px;">
                        @endif
                    </div>
                    {{-- <div class="form-group">
                        <label for="footer_text">Footer Text</label>
                        <textarea class="form-control" id="footer_text" name="footer_text" required>{{ $settings->settings['footer_text'] }}</textarea>
                    </div> --}}
                    {{-- <div class="form-group">
                        <label for="contact_us_map">Contact US Map</label>
                        <input type="text" class="form-control" id="contact_us_map" name="contact_us_map"   value="{{ $settings->settings['contact_us_map'] }}" required>
                    </div> --}}
...
{{--
                    ...
                    <div class="form-group">
                        ...
                        @if ($settings->settings['home_page_about_image'])
                            <img src="{{ $settings->settings['home_page_about_image'] }}" style="width: 100px;">
                        @endif
                    </div> --}}
                    {{-- <div style="display: none;" id="image-preview-section3">
                        @if ($settings->settings['home_page_about_image'])
                            <img src="{{ $settings->settings['home_page_about_image'] }}" id="image-preview3" alt="your image"
                                style="display:{{ is_null($settings->settings['home_page_about_image']) ? 'none' : 'block' }}; width: 100px;">
                        @endif
                    </div>
                    <div class="form-group">
                        ...
                        @if ($settings->settings['background_image'])
                            <img src="{{ $settings->settings['background_image'] }}" style="width: 100px;">
                        @endif
                    </div>
                    <div style="display: none;" id="image-preview-section4">
                        @if ($settings->settings['background_image'])
                            <img src="{{ $settings->settings['background_image'] }}" id="image-preview4" alt="your image"
                                style="display:{{ is_null($settings->settings['background_image']) ? 'none' : 'block' }}; width: 100px;">
                        @endif
                    </div>
                    <div class="form-group">
                        ...
                        @if ($settings->settings['speak_with_our_expert_logo'])
                            <img src="{{ $settings->settings['speak_with_our_expert_logo'] }}" style="width: 100px;">
                        @endif
                    </div>
                    <div style="display: none;" id="image-preview-section5">
                        @if ($settings->settings['speak_with_our_expert_logo'])
                            <img src="{{ $settings->settings['speak_with_our_expert_logo'] }}" id="image-preview5" alt="your image"
                                style="display:{{ is_null($settings->settings['speak_with_our_expert_logo']) ? 'none' : 'block' }}; width: 100px;">
                        @endif
                    </div>
                    <div class="form-group">
                        ...
                        @if ($settings->settings['speak_with_our_expert_image'])
                            <img src="{{ $settings->settings['speak_with_our_expert_image'] }}" style="width: 100px;">
                        @endif
                    </div>
                    <div style="display: none;" id="image-preview-section6">
                        @if ($settings->settings['speak_with_our_expert_image'])
                            <img src="{{ $settings->settings['speak_with_our_expert_image'] }}" id="image-preview6" alt="your image"
                                style="display:{{ is_null($settings->settings['speak_with_our_expert_image']) ? 'none' : 'block' }}; width: 100px;">
                        @endif
                    </div>
                    <div class="form-group">
                        <label for="banner_title">Banner Title</label>
                        <input type="text" class="form-control" id="banner_title" name="banner_title"
                            value="{{ $settings->settings['banner_title'] }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="home_page_video" name="home_page_video"
                            value="{{ $settings->settings['home_page_video'] }}" required>
                    </div>
                    <div class="form-group">
                        ...
                        @if ($settings->settings['Thumbnail_Video'])
                            <img src="{{ $settings->settings['Thumbnail_Video'] }}" style="width: 100px;">
                        @endif

                    </div>
                    <div style="display: none;" id="image-preview-section8">
                        @if ($settings->settings['Thumbnail_Video'])
                            <img src="{{ $settings->settings['Thumbnail_Video'] }}" id="image-preview8" alt="your image"
                                style="display:{{ is_null($settings->settings['Thumbnail_Video']) ? 'none' : 'block' }}; width: 100px;">
                        @endif
                    </div>
                    <div class="form-group">
                        ...
                        @if ($settings->settings['about_us_page_image'])
                            <img src="{{ $settings->settings['about_us_page_image'] }}" style="width: 100px;">
                        @endif
                    </div>
                    <div style="display: none;" id="image-preview-section7">
                        @if ($settings->settings['about_us_page_image'])
                            <img src="{{ $settings->settings['about_us_page_image'] }}" id="image-preview7" alt="your image"
                                style="display:{{ is_null($settings->settings['about_us_page_image']) ? 'none' : 'block' }}; width: 100px;">
                        @endif
                    </div>
                    <div class="form-group">
                        <label for="about_us_page_text">About Us Page Text</label>
                        <textarea class="form-control" id="description" name="about_us_page_text"
                            required>{{$settings->settings['about_us_page_text'] }}</textarea>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="about_us_page_review" name="about_us_page_review"
                            value="{{ $settings->settings['about_us_page_review'] }}" required>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="what_make_us_unique_first" name="what_make_us_unique_first"
                            value="{{ $settings->settings['what_make_us_unique_first'] }}" required>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="what_make_us_unique_second" name="what_make_us_unique_second"
                            value="{{ $settings->settings['what_make_us_unique_second'] }}" required>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="what_make_us_unique_third" name="what_make_us_unique_third"
                            value="{{ $settings->settings['what_make_us_unique_third'] }}" required>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="services_page_title" name="services_page_title"
                            value="{{ $settings->settings['services_page_title'] }}" required>
                    </div>
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="htmeditor" name="services_page_description"
                            required>{{$settings->settings['services_page_description'] }}</textarea>
                    </div>
                    <div class="form-group">
                        ...
                        @if ($settings->settings['services_page_image'])
                            <img src="{{ $settings->settings['services_page_image'] }}" style="width: 100px;">
                        @endif
                    ...
                    <div style="display: none;" id="image-preview-section8">
                        @if ($settings->settings['services_page_image'])
                            <img src="{{ $settings->settings['services_page_image'] }}" id="image-preview8" alt="your image"
                                style="display:{{ is_null($settings->settings['services_page_image']) ? 'none' : 'block' }}; width: 100px;">
                        @endif
                    </div> --}}
