        ...
        <form action="#">
            ...
            <div class="row my-2">
                <div class="col">
                    ...
                    <div class="input-group mb-3">
                        <input readonly type="text" class="form-control" name="name_ar"
                ...
                <div class="col">
                    ...
                    <div class="input-group mb-3 col">
                        <input readonly type="text" class="form-control " name="name_en"
            ...
            <div class="row my-2">
                <div class="col">
                    ...
                    <div class="input-group mb-3">
                        <textarea readonly name="short_description_ar" rows="3" cols="3" class="form-control ">{{ $product->getTranslation('short_description', 'ar') }}</textarea>
                    </div>
                ...
                <div class="col">
                    ...
                    <div class="input-group mb-3">
                        <textarea readonly name="short_description_en" rows="3" cols="3" class="form-control">{{ $product->getTranslation('short_description', 'en') }}</textarea>
                    </div>
            ...
            <div class="row my-2">
                <div class="col">
                    ...
                    <div class="input-group mb-3">
                        <textarea readonly name="description_ar" rows="3" cols="3" class="form-control">{{ $product->getTranslation('description', 'ar') }}</textarea>
                    </div>
                ...
                <div class="col">
                    ...
                    <div class="input-group mb-3">
                        <textarea readonly name="description_en" rows="3" cols="3" class="form-control">{{ $product->getTranslation('description', 'en') }}</textarea>
                    </div>
            ...
            <div class="row my-2">
                <div class="col">
                    ...
                    <div class="input-group mb-3">
                        <input readonly type="number" name="price" class="form-control " value="{{ $product->price }}">
                    </div>
                ...
                <div class="col">
                    ...
                    <div class="input-group mb-3">
                        <input readonly type="number" name="selling_price" class="form-control "
            ...
            <div class="row my-2">
                ...
                <div class="col">
                    ...
                    <div class="input-group mb-3">
                        <input readonly type="number" name="tax" class="form-control" value="{{ $product->tax }}">
                    </div>
            ...
            <div class="row my-2">
                <div class="col">
                    ...
                    <div class="input-group mb-3">
                        <input readonly type="text" name="meta_title" class="form-control "
            ...
            <div class="row my-2">
                <div class="col">
                    ...
                    <div class="input-group mb-3">
                        <textarea readonly name="meta_description_ar" rows="3" cols="3" class="form-control">{{ $product->getTranslation('meta_description', 'ar') }}</textarea>
                    </div>
                ...
                <div class="col">
                    ...
                    <div class="input-group mb-3">
                        <textarea readonly name="meta_description_en" rows="3" cols="3" class="form-control ">{{ $product->getTranslation('meta_description', 'en') }}</textarea>
                    </div>
