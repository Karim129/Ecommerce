    ...
    <form action="{{ route('categories.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col">
                ...
                <div class="input-group mb-3">
                    <input type="text" value="{{ old('name_ar') }}" class="form-control  @error('name_ar') is-invalid
            ...
            <div class="col">
                ...
                <div class="input-group mb-3 col">
                    <input type="text" value="{{ old('name_en') }}"
        ...
        <div class="row">
            <div class="col">
                ...
                <div class="input-group mb-3">
                    <input type="checkbox" value="1" {{ old('is_showing') ? 'checked' : '' }} class="" id="is_showing"
                        name="is_showing">
                </div>
            ...
            <div class="col">
                ...
                <div class="input-group mb-3 col">
                    <input type="checkbox" value="1" {{ old('is_popular') ? 'checked' : '' }} class="" id="is_popular"
                        name="is_popular">
                </div>
            </div>
        </div>
