...
<div class="row py-4 bg-warning">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb px-5">
            <li class="breadcrumb-item"><a href="{{route('get_categories')}}">{{trans('website_trans.category')}}</a>
            </li>
            ...
            <div class="col-md-8">
                <div class="card-body">
                    ...
                    <div class="py-4">
                        ...
                        <span class="float-end">{{trans('website_trans.selling_price')}} :
                    ...
                    <div class="row">
                        <div class="col-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control text-center" id="qty_vlaue" readonly value="1">
