        ...
        <div class="col-7">
            <div class="card">
                <div class="card-title text-center">
                    <h3>{{trans('website_trans.customer_details')}}</h3>
                </div>
                <div class="card-body">
                    <form action="">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" name="firstname" id="firstname"
                                    value="{{$user->fname}}" placeholder="your first name">
                            </div>
                            <div class="col">
                                <label for="lastname" class="form-label">{{trans('website_trans.last_name')}}</label>
                                <input type="text" class="form-control" name="lastname" id="lastname"
                                    value="{{$user->lname}}" placeholder="your last name">
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" name="address1" id="address1"
                                    value="{{$user->address1}}" placeholder="address1">
                            </div>
                            <div class="col">
                                <label for="address2" class="form-label">{{trans('website_trans.address_2')}}</label>
                                <input type="text" class="form-control" name="address2" id="address2"
                                    value="{{$user->address2}}" placeholder="address2">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <label for="city" class="form-label">{{trans('website_trans.city')}}</label>
                                <input type="text" value="{{$user->city}}" class="form-control" name="city" id="city"
                                    placeholder="city">
                            </div>
                            <div class="col">
