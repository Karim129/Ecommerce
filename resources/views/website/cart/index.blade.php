                    ...
                    <div class="card-body p-4">
                        <div class="row d-flex justify-content-between align-items-center">
                            ...
                            <div class="col-md-3 col-lg-3 col-xl-2 d-flex">
                                ...
                                <input id="qty_{{$product_cart->id}}" min="0" name="qty" value="{{$product_cart->qty}}"
                                    type="text" class="form-control form-control-sm qty_{{$product_cart->id}}" />
                            ...
                            <div class="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                                <h5 class="mb-0">
                                    @php $product_total = $product_cart->Product->selling_price *
                                    $product_cart->qty;
                                    @endphp
                                    {{$product_total}}
                                </h5>
